...
class Ui_Form(QWidget):
    def setupUi(self, Pogoda):
        ...
        self.gismet_value.setGeometry(QtCore.QRect(400, 240, 720, 71))
        ...
        self.gismet.setGeometry(QtCore.QRect(50, 240, 270, 71))
        ...
        self.yandex_value.setGeometry(QtCore.QRect(400, 400, 720, 71))
        ...
        self.yandex.setGeometry(QtCore.QRect(50, 400, 270, 71))
        ...
        self.pogoda_value.setGeometry(QtCore.QRect(400, 560, 720, 71))
        ...
        self.pogoda.setGeometry(QtCore.QRect(50, 560, 300, 71))
    ...
    def retranslateUi(self, Pogoda):
        ...
        self.gismet_value.setText(_translate("Form", f"{rt[0]}°C  ветер:{rt[1][0]}  влажность:{rt[2]}"))
        self.gismet_value.adjustSize()
        self.pogoda_value.setText(_translate("Form", f"{rt[6]}C  ветер:{rt[7]}м/с  влажность:{rt[8]} "))
        self.pogoda_value.adjustSize()
        self.gismet.setText(_translate("Form", "GISMETIO"))
        self.yandex_value.setText(_translate("Form", f"{rt[3]}°C  ветер:{rt[4]}м/с  влажность:{rt[5]}"))
        self.yandex_value.adjustSize()
        self.yandex.setText(_translate("Form", "YANDEX.BY"))
        self.pogoda.setText(_translate("Form", "POGODA.MAIL"))
